...
function Lovedands() {
    const [Lovedands, setLovedands] = useState([]);
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:4000/Love-Bands')
            .then(response => {
        ...
        <Centerrpage/>
            <div className="container">
                <div className="col-md-12">
                    <h1 className="products">Lovedands</h1>
                </div>
                <div className="row product-list">
                    {Lovedands.slice(0, visibleProducts).map(product => (
                ...
                {visibleProducts < Lovedands.length && (
